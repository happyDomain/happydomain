...
<script lang="ts">
    ...
    import CAAIssuerParameter from "./issuer-parameter.svelte";
    import { issuers, rev_issuers } from "./issuers";
    import { parseCAAIssuer, stringifyCAAIssuer } from "./model.svelte";
    ...
    $effect(() => {
        val = parseCAAIssuer(value, newone);
    });
    $effect(() => {
        value = stringifyCAAIssuer(val, value);
    });
