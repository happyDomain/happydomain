...
// The rdata of an SVCB key or an EDNS0 option depends on the code carrying
// it, which the record alone knows: both stay opaque here.
export type SVCBKeyValue = unknown;

export type EDNS0 = unknown;
