...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/route53 v1.29.2 // indirect
...
replace github.com/StackExchange/dnscontrol/v4 => github.com/happyDomain/dnscontrol/v4 v4.3.10
