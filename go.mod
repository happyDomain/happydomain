...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/route53domains v1.34.10 // indirect
...
replace github.com/StackExchange/dnscontrol/v4 => github.com/happyDomain/dnscontrol/v4 v4.13.100
