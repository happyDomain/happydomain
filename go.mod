...
require (
	...
	github.com/cloudflare/cloudflare-go v0.77.0 // indirect
	...
	github.com/nrdcg/goinwx v0.8.3 // indirect
...
replace github.com/StackExchange/dnscontrol/v4 => github.com/happyDomain/dnscontrol/v4 v4.4.10
