...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/route53 v1.22.4 // indirect
...
replace github.com/StackExchange/dnscontrol/v3 => github.com/nemunaire/dnscontrol/v3 v3.22.10
