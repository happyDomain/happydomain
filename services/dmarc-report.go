...
func dmarc_report_analyze(a *svc.Analyzer) (err error) {
	services := map[string]*DMARCReport{}

	for _, record := range a.SearchRR(svc.AnalyzerRecordFilter{Type: dns.TypeTXT, DomainContains: "._report._dmarc"}) {
