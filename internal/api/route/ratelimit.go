...
// and per client.
//
// It keys on middleware.ClientKey, which honours -trusted-proxy: the
// unauthenticated endpoints it protects are meant to sit behind a reverse
// proxy, and without that the whole Internet would share the proxy's budget.
