...
func DeclareTestScheduleRoutes(router *gin.RouterGroup, testScheduleUC happydns.TestScheduleUsecase) {
	sc := controller.NewTestScheduleController(testScheduleUC)
