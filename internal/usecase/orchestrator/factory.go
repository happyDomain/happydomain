...
// be retrieved, diffed and published by invited users.
type ProviderGetter interface {
	GetProviderForZone(ctx context.Context, user *happydns.User, providerID happydns.Identifier) (*happydns.Provider, error)
}
