...
func explodeAbstractEMail(dn happydns.Subdomain, in *happydns.ServiceMessage) ([]*happydns.ServiceMessage, error) {
	...
	if val.SPF != nil {
		if _, ok := val.SPF["directives"].([]interface{}); ok {
			...
			sm.Service, err = json.Marshal(svcs.SPF{happydns.NewTXT(helpers.RRRelative(rr, "zZzZ.").(*dns.TXT))})
			if err != nil {
				return nil, err
			}
			ret = append(ret, &sm)
...
func migrateFrom7(s *LevelDBStorage) (err error) {
	...
	migrateFrom7SvcType["abstract.MatrixIM"] = func(in json.RawMessage) (json.RawMessage, error) {
		...
		if mat, ok := val["matrix"].([]interface{}); ok {
			for _, mI := range mat {
				...
				rr, err := dns.NewRR(fmt.Sprintf("_matrix._tcp.zZzZ. 0 IN SRV %.0f %.0f %0.f %s", m["priority"].(float64), m["weight"].(float64), m["port"].(float64), helpers.DomainFQDN(m["target"].(string), "zZzZ.")))
				if err != nil {
					return nil, err
				}
				if rr != nil {
	...
	migrateFrom7SvcType["abstract.RFC6186"] = func(in json.RawMessage) (json.RawMessage, error) {
		...
		if _, ok := val["submission"].([]interface{}); ok {
			for _, clientI := range val["submission"].([]interface{}) {
				...
				rr, err := dns.NewRR(fmt.Sprintf("%s.zZzZ. 0 IN SRV %.0f %.0f %.0f %s", helpers.DomainJoin("_submission", "_tcp"), client["priority"], client["weight"], client["port"], helpers.DomainFQDN(client["target"].(string), "zZzZ.")))
				if err != nil {
					return nil, err
				}
				if rr != nil {
		...
		if _, ok := val["imaps"].([]interface{}); ok {
			for _, clientI := range val["imaps"].([]interface{}) {
				client := clientI.(map[string]interface{})
				rr, err := dns.NewRR(fmt.Sprintf("%s.zZzZ. 0 IN SRV %.0f %.0f %.0f %s", helpers.DomainJoin("_imaps", "_tcp"), client["priority"], client["weight"], client["port"], helpers.DomainFQDN(client["target"].(string), "zZzZ.")))
				if err != nil {
					return nil, err
				}
				if rr != nil {
		...
		if _, ok := val["pop3s"].([]interface{}); ok {
			for _, clientI := range val["pop3s"].([]interface{}) {
				client := clientI.(map[string]interface{})
				rr, err := dns.NewRR(fmt.Sprintf("%s.zZzZ. 0 IN SRV %.0f %.0f %.0f %s", helpers.DomainJoin("_pop3s", "_tcp"), client["priority"], client["weight"], client["port"], helpers.DomainFQDN(client["target"].(string), "zZzZ.")))
				if err != nil {
					return nil, err
				}
				if rr != nil {
		...
		if _, ok := val["submissions"].([]interface{}); ok {
			for _, clientI := range val["submissions"].([]interface{}) {
				client := clientI.(map[string]interface{})
				rr, err := dns.NewRR(fmt.Sprintf("%s.zZzZ. 0 IN SRV %.0f %.0f %.0f %s", helpers.DomainJoin("_submissions", "_tcp"), client["priority"], client["weight"], client["port"], helpers.DomainFQDN(client["target"].(string), "zZzZ.")))
				if err != nil {
					return nil, err
				}
				if rr != nil {
		...
		if _, ok := val["imap"].([]interface{}); ok {
			for _, clientI := range val["imap"].([]interface{}) {
				client := clientI.(map[string]interface{})
				rr, err := dns.NewRR(fmt.Sprintf("%s.zZzZ. 0 IN SRV %.0f %.0f %.0f %s", helpers.DomainJoin("_imap", "_tcp"), client["priority"], client["weight"], client["port"], helpers.DomainFQDN(client["target"].(string), "zZzZ.")))
				if err != nil {
					return nil, err
				}
				if rr != nil {
		...
		if _, ok := val["pop3"].([]interface{}); ok {
			for _, clientI := range val["pop3"].([]interface{}) {
				client := clientI.(map[string]interface{})
				rr, err := dns.NewRR(fmt.Sprintf("%s.zZzZ. 0 IN SRV %.0f %.0f %.0f %s", helpers.DomainJoin("_pop3", "_tcp"), client["priority"], client["weight"], client["port"], helpers.DomainFQDN(client["target"].(string), "zZzZ.")))
				if err != nil {
					return nil, err
				}
				if rr != nil {
	...
	migrateFrom7SvcType["svcs.CAA"] = func(in json.RawMessage) (json.RawMessage, error) {
		...
		return json.Marshal(svcs.CAAPolicy{rrs})
	}
	...
	migrateFrom7SvcType["svcs.CNAME"] = func(in json.RawMessage) (json.RawMessage, error) {
		...
		return json.Marshal(svcs.CNAME{helpers.RRRelative(rr, "zZzZ").(*dns.CNAME)})
	}
	...
	migrateFrom7SvcType["svcs.DKIMRecord"] = func(in json.RawMessage) (json.RawMessage, error) {
		...
		return json.Marshal(svcs.DKIMRecord{happydns.NewTXT(helpers.RRRelative(rr, "zZzZ").(*dns.TXT))})
	}
	...
	migrateFrom7SvcType["svcs.DMARC"] = func(in json.RawMessage) (json.RawMessage, error) {
		...
		return json.Marshal(svcs.DMARC{happydns.NewTXT(helpers.RRRelative(rr, "zZzZ").(*dns.TXT))})
	}
	...
	migrateFrom7SvcType["svcs.SPF"] = func(in json.RawMessage) (json.RawMessage, error) {
		...
		return json.Marshal(svcs.SPF{happydns.NewTXT(helpers.RRRelative(rr, "zZzZ").(*dns.TXT))})
	}
	...
	migrateFrom7SvcType["svcs.TXT"] = func(in json.RawMessage) (json.RawMessage, error) {
		...
		return json.Marshal(svcs.TXT{happydns.NewTXT(helpers.RRRelative(rr, "zZzZ").(*dns.TXT))})
	}
	...
	migrateFrom7SvcType["svcs.UnknownSRV"] = func(in json.RawMessage) (json.RawMessage, error) {
		...
		if mat, ok := val["srv"].([]interface{}); ok {
			for _, mI := range mat {
				m := mI.(map[string]interface{})
				rr, err := dns.NewRR(fmt.Sprintf("%s 0 IN SRV %.0f %.0f %0.f %s", helpers.DomainJoin("_"+val["name"].(string), "_"+val["proto"].(string), "zZzZ"), m["priority"].(float64), m["weight"].(float64), m["port"].(float64), helpers.DomainFQDN(m["target"].(string), "zZzZ.")))
				if err != nil {
					return nil, err
				}
				if rr != nil {
	...
	migrateFrom7SvcType["svcs.Orphan"] = func(in json.RawMessage) (json.RawMessage, error) {
		...
		return json.Marshal(svcs.Orphan{helpers.RRRelative(rr, "zZzZ")})
	}
